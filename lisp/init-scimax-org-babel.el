...
;; (define-key evil-insert-state-map (kbd "C-d C-d") 'company-ob-ipython)
(define-key evil-insert-state-map (kbd "C-S-i") 'scimax-ob-ipython-complete-ivy)

(provide 'init-scimax-org-babel)
